...
// Components
import { Button, Card, StarRating, ErrorFeedback } from '../../components';
...
const HotelDetailScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  const handleBookNow = withErrorHandling(
    async (room: any) => {
      if (!selectedDates.checkIn || !selectedDates.checkOut) {
        showUserFeedback('Please select check-in and check-out dates.', 'warning');
        return;
      }
      ...
      if (nights <= 0) {
        showUserFeedback('Check-out date must be after check-in date.', 'warning');
        return;
      }
    ...
    {
      errorMessage: 'Failed to book room. Please try again.',
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => showUserFeedback('Hotel saved to favorites!', 'success')}
          >
        ...
        <Card style={styles.bookingCard}>
          ...
          <View style={styles.dateSelection}>
            <TouchableOpacity 
              ...
              onPress={() => showUserFeedback('In a complete implementation, this would open a date picker', 'info')}
            >
          ...
          <Card style={styles.reviewsCard}>
            ...
            <View style={styles.reviewSummary}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => showUserFeedback('In a complete implementation, this would show all reviews', 'info')}
              >
